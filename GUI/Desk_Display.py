...
if __name__ == "__main__":
    ...
    class SampleApp(Tk):
        ...
        def __init__(self, *args, **kwargs):
            ...
            headers = []
            headers.append('Desk#')
            for col in desk_display_df.columns:
                #print(col)
                headers.append(col)
            headerindex = 0
            for i in headers:
                tk.Label(self.frame.interior,text=i,font=("Helvetica", 16),bg = 'cyan',anchor= 'e',relief = 'solid').grid(row = 1, column = headerindex, sticky = 'w'+'e')
                headerindex +=1
            ...
            for i in listedDF:
                for j in i:
                    tk.Label(self.frame.interior,text=j,font=("Helvetica", 16),bg = 'violet', anchor = 'e', relief = 'solid').grid(row = i_index, column = j_index, sticky = 'w'+'e')
                    j_index +=1
                i_index +=1
                j_index = 0
