...
Browse for File
Enter Sheet Name and Verify
link to melt_file
Take to filter page (pg 2)

## Page 2: Filter Page

Desks: filter by day and desk
Flights: filter by day, hour, desk, org, dest

get inputs for each parameter he enters and run it through respective function

Desks_Next: link to desk_display, handoffs have to be handled here
Flights_Next: link to flights_filter

##Page 3: Desk Display

Display 4 metrics for each desk with coloring scheme
Visualize button at top linked to graphs display
Vertical scroll bar

## Page 4: Flight Display

Display all flights
ALlow two views, unpivoted, and pivoted
Figure out horizontal scroll bar
Vertical scrollbar

## Page 5: Graphs Display

Linked to 3 or 4 graphs for that desk, Handoffs has to be handled here
