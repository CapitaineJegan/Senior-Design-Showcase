...
def melt_file(file):
    ...
    #THIS MELTS DF
    melt = pd.melt(df, id_vars=['Flt','Org','Dst','Eqt','Dptr','Arvl','BLK MINS','MILES','Desk','HNDOFF'] 
    ...
    export_csv = melt.to_csv(r'sep_2019 MELT.csv', header=True)
    return melt
    #Export melted df to a csv
#export_csv = melt.to_csv(r'sep_2019 MELT.csv', header=True) #CHANGE FILE NAME

melt_file('sep_2019.xlsx')

#Set day
daymelt = melt[melt['Date'].dt.day == 1]
deskmelt = daymelt[daymelt['Desk'] == 3]
